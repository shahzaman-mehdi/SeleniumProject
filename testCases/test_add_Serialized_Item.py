...
class Test_003_Add_Serialized_Item:
    ...
    def test_addSerializedItem(self, setup):
        self.logger.info("********** Test_003_Add_Serialized_Item **********")
        self.logger.info("********** Verifying Add Serialized Item **********")
        ...
        self.ai.selectItemType()
        self.ai.selectItemMake()
        self.ai.selectItemBrand()
        self.ai.selectItemModel()

        self.memory = 'M' + randomNumber()
        self.ai.addItemMemoryAtribute(self.memory)
        self.ai.selectItemMemory(self.memory)
